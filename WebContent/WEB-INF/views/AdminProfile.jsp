...
<div class="profile-main">
    ...
    <div class="right">
        <button onclick="window.location='http://localhost:8016/Java_Case_Study/SearchBook'"><i class="fa fa-search" aria-hidden="true"></i>
            SEARCH BOOK</button>
        <button onclick="window.location='http://localhost:8016/Java_Case_Study/addliberian'"><i class="fa fa-plus" aria-hidden="true"></i>
            ADD LIBERIAN</button>
