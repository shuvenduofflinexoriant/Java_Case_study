	...
	<div class="profile-main">
		<div class="left">
			<svg alt="profile-picture" width="250px" height="300px"
				id="f36e36b5-a914-4189-a8f7-2c7091a7d461" data-name="Layer 1"
				xmlns="http://www.w3.org/2000/svg" width="676" height="676"
				viewBox="0 0 676 676">
			...
			<path
				...
				transform="translate(-262 -112)" fill="#2f2e41" />
			<path d="M675.00335,303.87618s-7.59666,34.93809,39.87428,48.91333Z"
				transform="translate(-262 -112)" fill="#2f2e41" />
			<path d="M468.86862,310.23519s17.469,39.06051-34.93809,56.52955Z"
				transform="translate(-262 -112)" fill="#2f2e41" />
		...
		<div class="right">
			...
			<button
				onclick="window.location='http://localhost:8016/Java_Case_Study/addliberian'">
				<i class="fa fa-plus" aria-hidden="true"></i> ADD LIBERIAN
			</button>
			<button
				onclick="window.location='http://localhost:8016/Java_Case_Study/allissuedbooks'">
