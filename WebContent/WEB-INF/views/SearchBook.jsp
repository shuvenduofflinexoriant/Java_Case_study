		...
		<tbody>
			...
			<tr>
	      			...
	      			<%if(book.getAvailableQuantity()>0){ %>
	  	  			...
	  	  			<% }else {%><td><button class="btn btn-danger" disabled type="submit">Book not available</button></td><%}} else { %>
	  	  			
	  	  			<td><button class="btn btn-success" onclick="window.location='http://localhost:8016/Java_Case_Study/editBook/<%=book.getBookId()%>'"  type="submit">EDIT</button>
	  	  			<%}; %>
	    		</tr>
	    		<%
				}
