		...
		<tbody>
			...
			<tr>
	      			...
	      			<td><%=res.getString("description") %></td>
	  	  			<td><%if(Integer.parseInt(res.getString("availableQuantity"))>0) %><button class="btn btn-primary"  type="submit">ISSUE</button><% else %><button class="btn btn-primary" disabled type="submit">Book not available</button><%; %>
	    		</tr>
	    		<%
				}
			}catch(Exception e)
