<%@page import="com.xoriant.beans.Status"%>
...
<tr><th>ID</th><th>Book Id</th><th>Issue Date</th><th>Returning date</th><th>Days Left</th><th>Status</th><th>Approver</th><th>Fine</th><th>Action</th></tr>
</thead>
<%
...
if(request.getAttribute("issuedBooks") != null)  // Null check for the object
{
	...
	<tr><td class="text-primary"><%=issuedBook.getIssueId()%></td>
		...
		<td class="text-primary"><a href="/Java_Case_Study/returnBook/<%=issuedBook.getIssueId()%>">RETURN BOOK</a></td>
		<%} else { %>
		<td class="text-primary">RETURN REQUESTED</td>
		<%} %>
	</tr>
	<%
	}
