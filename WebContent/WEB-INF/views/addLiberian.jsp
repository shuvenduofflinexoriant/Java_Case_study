...
<body>
<h3 class="text-info">REGISTER LIBRARIAN</h3>
<form class="form-inline" action=" http://localhost:8016/Java_Case_Study/liberianadded" method="POST">
	
		
		<label for="name"><b> Liberian Name:</b></label>
		<input type="text" name="liberianName" id="liberianName" style="margin-top:-30px !important;"required >
		<br></br>
