	...
	<tbody>
	    <c:forEach items="${studentData}" var="student">
	      <tr>
		      ...
		      <td class="text-primary" ><c:out value="${student.admissionDate}"/></td>
		      <td class="text-primary" ><c:out value="${student.releaseDate}"/></td>
		      <td class="text-primary" ><c:out value="${student.address}"/></td>
		      <td class="text-primary" ><c:out value="${student.contactNumber}"/></td>
		      <td ><a class="text-primary"  href="<c:url value='/approveStudentRegistration/${student.userId}'/>">Approve</a></td>
		  </tr>
